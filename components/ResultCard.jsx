...
import {
  ...
  Globe, Lock, Unlock, ExternalLink, Microscope, Info,
  Building2, Tag, Lightbulb,
} from "lucide-react";
          ...
          >
            <div className="relative w-16 h-16">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="font-display font-bold text-base text-white leading-none">{score}</span>
